...
public interface RelationshipOrBuilder extends
   ...
   * @return The object.
   */
  api.rebac.v1.ObjectReference getObject();
  /**
   * <code>.api.rebac.v1.ObjectReference object = 1;</code>
   */
  api.rebac.v1.ObjectReferenceOrBuilder getObjectOrBuilder();
   ...
   * @return The subject.
   */
  api.rebac.v1.SubjectReference getSubject();
  /**
   * <code>.api.rebac.v1.SubjectReference subject = 3;</code>
   */
  api.rebac.v1.SubjectReferenceOrBuilder getSubjectOrBuilder();
}
