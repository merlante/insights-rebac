...
public interface CreateRelationshipsRequestOrBuilder extends
   ...
   */
  java.util.List<api.rebac.v1.Relationship> 
      getRelationshipsList();
  /**
   * <code>repeated .api.rebac.v1.Relationship relationships = 2;</code>
   */
  api.rebac.v1.Relationship getRelationships(int index);
  /**
   * <code>repeated .api.rebac.v1.Relationship relationships = 2;</code>
   */
   ...
   * <code>repeated .api.rebac.v1.Relationship relationships = 2;</code>
   */
  java.util.List<? extends api.rebac.v1.RelationshipOrBuilder> 
      getRelationshipsOrBuilderList();
  /**
   * <code>repeated .api.rebac.v1.Relationship relationships = 2;</code>
   */
  api.rebac.v1.RelationshipOrBuilder getRelationshipsOrBuilder(
      int index);
}
