...
public final class RelationshipsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<api.rebac.v1.CreateRelationshipsRequest,
      api.rebac.v1.CreateRelationshipsResponse> getCreateRelationshipsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateRelationships",
      requestType = api.rebac.v1.CreateRelationshipsRequest.class,
      responseType = api.rebac.v1.CreateRelationshipsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<api.rebac.v1.CreateRelationshipsRequest,
      api.rebac.v1.CreateRelationshipsResponse> getCreateRelationshipsMethod() {
    io.grpc.MethodDescriptor<api.rebac.v1.CreateRelationshipsRequest, api.rebac.v1.CreateRelationshipsResponse> getCreateRelationshipsMethod;
      ...
      synchronized (RelationshipsGrpc.class) {
        if ((getCreateRelationshipsMethod = RelationshipsGrpc.getCreateRelationshipsMethod) == null) {
          RelationshipsGrpc.getCreateRelationshipsMethod = getCreateRelationshipsMethod =
              io.grpc.MethodDescriptor.<api.rebac.v1.CreateRelationshipsRequest, api.rebac.v1.CreateRelationshipsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateRelationships"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  api.rebac.v1.CreateRelationshipsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  api.rebac.v1.CreateRelationshipsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<api.rebac.v1.ReadRelationshipsRequest,
      api.rebac.v1.ReadRelationshipsResponse> getReadRelationshipsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReadRelationships",
      requestType = api.rebac.v1.ReadRelationshipsRequest.class,
      responseType = api.rebac.v1.ReadRelationshipsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<api.rebac.v1.ReadRelationshipsRequest,
      api.rebac.v1.ReadRelationshipsResponse> getReadRelationshipsMethod() {
    io.grpc.MethodDescriptor<api.rebac.v1.ReadRelationshipsRequest, api.rebac.v1.ReadRelationshipsResponse> getReadRelationshipsMethod;
      ...
      synchronized (RelationshipsGrpc.class) {
        if ((getReadRelationshipsMethod = RelationshipsGrpc.getReadRelationshipsMethod) == null) {
          RelationshipsGrpc.getReadRelationshipsMethod = getReadRelationshipsMethod =
              io.grpc.MethodDescriptor.<api.rebac.v1.ReadRelationshipsRequest, api.rebac.v1.ReadRelationshipsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReadRelationships"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  api.rebac.v1.ReadRelationshipsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  api.rebac.v1.ReadRelationshipsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<api.rebac.v1.DeleteRelationshipsRequest,
      api.rebac.v1.DeleteRelationshipsResponse> getDeleteRelationshipsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DeleteRelationships",
      requestType = api.rebac.v1.DeleteRelationshipsRequest.class,
      responseType = api.rebac.v1.DeleteRelationshipsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<api.rebac.v1.DeleteRelationshipsRequest,
      api.rebac.v1.DeleteRelationshipsResponse> getDeleteRelationshipsMethod() {
    io.grpc.MethodDescriptor<api.rebac.v1.DeleteRelationshipsRequest, api.rebac.v1.DeleteRelationshipsResponse> getDeleteRelationshipsMethod;
      ...
      synchronized (RelationshipsGrpc.class) {
        if ((getDeleteRelationshipsMethod = RelationshipsGrpc.getDeleteRelationshipsMethod) == null) {
          RelationshipsGrpc.getDeleteRelationshipsMethod = getDeleteRelationshipsMethod =
              io.grpc.MethodDescriptor.<api.rebac.v1.DeleteRelationshipsRequest, api.rebac.v1.DeleteRelationshipsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DeleteRelationships"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  api.rebac.v1.DeleteRelationshipsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  api.rebac.v1.DeleteRelationshipsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createRelationships(api.rebac.v1.CreateRelationshipsRequest request,
        io.grpc.stub.StreamObserver<api.rebac.v1.CreateRelationshipsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateRelationshipsMethod(), responseObserver);
    }

    /**
     */
    default void readRelationships(api.rebac.v1.ReadRelationshipsRequest request,
        io.grpc.stub.StreamObserver<api.rebac.v1.ReadRelationshipsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getReadRelationshipsMethod(), responseObserver);
    }

    /**
     */
    default void deleteRelationships(api.rebac.v1.DeleteRelationshipsRequest request,
        io.grpc.stub.StreamObserver<api.rebac.v1.DeleteRelationshipsResponse> responseObserver) {
  ...
  public static final class RelationshipsStub
    ...
    /**
     */
    public void createRelationships(api.rebac.v1.CreateRelationshipsRequest request,
        io.grpc.stub.StreamObserver<api.rebac.v1.CreateRelationshipsResponse> responseObserver) {
    ...
    /**
     */
    public void readRelationships(api.rebac.v1.ReadRelationshipsRequest request,
        io.grpc.stub.StreamObserver<api.rebac.v1.ReadRelationshipsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
    ...
    /**
     */
    public void deleteRelationships(api.rebac.v1.DeleteRelationshipsRequest request,
        io.grpc.stub.StreamObserver<api.rebac.v1.DeleteRelationshipsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class RelationshipsBlockingStub
    ...
    /**
     */
    public api.rebac.v1.CreateRelationshipsResponse createRelationships(api.rebac.v1.CreateRelationshipsRequest request) {
    ...
    /**
     */
    public api.rebac.v1.ReadRelationshipsResponse readRelationships(api.rebac.v1.ReadRelationshipsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public api.rebac.v1.DeleteRelationshipsResponse deleteRelationships(api.rebac.v1.DeleteRelationshipsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RelationshipsFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<api.rebac.v1.CreateRelationshipsResponse> createRelationships(
        api.rebac.v1.CreateRelationshipsRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<api.rebac.v1.ReadRelationshipsResponse> readRelationships(
        api.rebac.v1.ReadRelationshipsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<api.rebac.v1.DeleteRelationshipsResponse> deleteRelationships(
        api.rebac.v1.DeleteRelationshipsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_RELATIONSHIPS:
          serviceImpl.createRelationships((api.rebac.v1.CreateRelationshipsRequest) request,
              (io.grpc.stub.StreamObserver<api.rebac.v1.CreateRelationshipsResponse>) responseObserver);
          break;
        case METHODID_READ_RELATIONSHIPS:
          serviceImpl.readRelationships((api.rebac.v1.ReadRelationshipsRequest) request,
              (io.grpc.stub.StreamObserver<api.rebac.v1.ReadRelationshipsResponse>) responseObserver);
          break;
        case METHODID_DELETE_RELATIONSHIPS:
          serviceImpl.deleteRelationships((api.rebac.v1.DeleteRelationshipsRequest) request,
              (io.grpc.stub.StreamObserver<api.rebac.v1.DeleteRelationshipsResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              api.rebac.v1.ReadRelationshipsRequest,
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              api.rebac.v1.DeleteRelationshipsRequest,
  ...
  private static abstract class RelationshipsBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return api.rebac.v1.RelationshipsOuterClass.getDescriptor();
    }
