...
/**
 * Protobuf type {@code api.rebac.v1.Relationship}
 */
public final class Relationship extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:api.rebac.v1.Relationship)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return api.rebac.v1.RelationshipsOuterClass.internal_static_api_rebac_v1_Relationship_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return api.rebac.v1.RelationshipsOuterClass.internal_static_api_rebac_v1_Relationship_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            api.rebac.v1.Relationship.class, api.rebac.v1.Relationship.Builder.class);
  }
  ...
  private api.rebac.v1.SubjectReference subject_;
  /**
   ...
   */
  @java.lang.Override
  public api.rebac.v1.SubjectReference getSubject() {
    return subject_ == null ? api.rebac.v1.SubjectReference.getDefaultInstance() : subject_;
  }
  /**
   * <code>.api.rebac.v1.SubjectReference subject = 3;</code>
   */
  @java.lang.Override
  public api.rebac.v1.SubjectReferenceOrBuilder getSubjectOrBuilder() {
    return subject_ == null ? api.rebac.v1.SubjectReference.getDefaultInstance() : subject_;
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof api.rebac.v1.Relationship)) {
      return super.equals(obj);
    }
    api.rebac.v1.Relationship other = (api.rebac.v1.Relationship) obj;
  ...
  public static api.rebac.v1.Relationship parseFrom(
  ...
  public static api.rebac.v1.Relationship parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static api.rebac.v1.Relationship parseFrom(
  ...
  public static api.rebac.v1.Relationship parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static api.rebac.v1.Relationship parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static api.rebac.v1.Relationship parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(api.rebac.v1.Relationship prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:api.rebac.v1.Relationship)
      api.rebac.v1.RelationshipOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return api.rebac.v1.RelationshipsOuterClass.internal_static_api_rebac_v1_Relationship_descriptor;
    }
    ...
    // Construct using api.rebac.v1.Relationship.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public api.rebac.v1.Relationship getDefaultInstanceForType() {
      return api.rebac.v1.Relationship.getDefaultInstance();
    }

    @java.lang.Override
    public api.rebac.v1.Relationship build() {
      api.rebac.v1.Relationship result = buildPartial();
    ...
    @java.lang.Override
    public api.rebac.v1.Relationship buildPartial() {
      api.rebac.v1.Relationship result = new api.rebac.v1.Relationship(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(api.rebac.v1.Relationship result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof api.rebac.v1.Relationship) {
        return mergeFrom((api.rebac.v1.Relationship)other);
      } else {
    ...
    public Builder mergeFrom(api.rebac.v1.Relationship other) {
      if (other == api.rebac.v1.Relationship.getDefaultInstance()) return this;
      if (other.hasObject()) {
    ...
    private api.rebac.v1.SubjectReference subject_;
    private com.google.protobuf.SingleFieldBuilderV3<
        api.rebac.v1.SubjectReference, api.rebac.v1.SubjectReference.Builder, api.rebac.v1.SubjectReferenceOrBuilder> subjectBuilder_;
    /**
     * <code>.api.rebac.v1.SubjectReference subject = 3;</code>
     * @return Whether the subject field is set.
     */
     ...
     * <code>.api.rebac.v1.SubjectReference subject = 3;</code>
     */
    public Builder setSubject(api.rebac.v1.SubjectReference value) {
      if (subjectBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setSubject(
        api.rebac.v1.SubjectReference.Builder builderForValue) {
      if (subjectBuilder_ == null) {
     ...
     * <code>.api.rebac.v1.SubjectReference subject = 3;</code>
     */
    public Builder mergeSubject(api.rebac.v1.SubjectReference value) {
      if (subjectBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          subject_ != null &&
          subject_ != api.rebac.v1.SubjectReference.getDefaultInstance()) {
     ...
     * <code>.api.rebac.v1.SubjectReference subject = 3;</code>
     */
    public api.rebac.v1.SubjectReference.Builder getSubjectBuilder() {
      bitField0_ |= 0x00000004;
      onChanged();
    ...
    public api.rebac.v1.SubjectReferenceOrBuilder getSubjectOrBuilder() {
      if (subjectBuilder_ != null) {
        ...
        return subject_ == null ?
            api.rebac.v1.SubjectReference.getDefaultInstance() : subject_;
      }
    }
    /**
     * <code>.api.rebac.v1.SubjectReference subject = 3;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        api.rebac.v1.SubjectReference, api.rebac.v1.SubjectReference.Builder, api.rebac.v1.SubjectReferenceOrBuilder> 
    ...
    // @@protoc_insertion_point(builder_scope:api.rebac.v1.Relationship)
  }

  // @@protoc_insertion_point(class_scope:api.rebac.v1.Relationship)
  private static final api.rebac.v1.Relationship DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new api.rebac.v1.Relationship();
  }

  public static api.rebac.v1.Relationship getDefaultInstance() {
