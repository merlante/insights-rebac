...
func (s *SpiceDbRepository) LookupSubjects(ctx context.Context, subject_type, subject_relation, relation string, object *apiV1.ObjectReference, limit uint32, continuation biz.ContinuationToken) (chan *biz.SubjectResult, chan error, error) {
